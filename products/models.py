...
class Product(models.Model):
    ...
    @classmethod
    def add_products(cls, fat_100g, name, image_product, nutriscore, salt_100g, saturated_fat_100g, sugars_100g, url, categories):
        data = cls(fat_100g=fat_100g, name=name, image_product=image_product, nutriscore=nutriscore, salt_100g=salt_100g, saturated_fat_100g=saturated_fat_100g, sugars_100g=sugars_100g, url=url, categories=categories)
        data.save()
